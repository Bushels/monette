...
NARRATIVE = {
    ...
    "swift-current": (
        ...
        "The 2026-01-18 ISC snapshot adds 28 records (post-dedup of "
        "duplicate-titled LSDs): 16 reassigned in from wymark (Stewart Valley "
        "townships T13/R13-R14/W3 — clean quarters and LSDs that the older "
        "Wymark sale-package XLSX had absorbed) plus 12 net-new LSD ADDs "
        "with computed DLS polygons. The 49,775-acre court-file claim is "
        "NOT reconciled by this 31-CSV-row subset — the bulk likely sits "
        "under non-MFL Monette entities or leased land outside the ISC "
        "title-export scope."
    ),
    "regina-south": (
        ...
        "The 2026-01-18 ISC snapshot adds 120 records (post-dedup of "
        "extension-variant duplicates) covering RM Lajord 128 "
        "(Riceton/Drinkwater area, T15-R18-W2M), RM Bratt's Lake 129 "
        "(Wilcox area), RM Edenwold 158 (White City area, T16-R18-W2M "
        "directly N of Lajord), and RM Longlaketon 219 (Lumsden area, "
        "1 parcel reassigned from raymore). Lajord + Edenwold form a "
        "contiguous block south-then-north of Regina city. All quarter "
        "polygons computed via DLS math in Phase 4."
    ),
    "wymark": (
    ...
    "calderbank": (
        ...
        "block). Plus 3 net-new ADDs with DLS quarter/LSD polygons "
        "computed in Phase 4 (1 quarter remains as a planned-parcel "
        "skip — BLK-A-PLAN-101641991 — pending cadastral data)."
    ),
    "vanguard": (
        "Folded 16 Village of Neville records into vanguard as the closest "
        "property anchor (~17km NE of Neville village); 1 duplicate-loc "
        "extension-variant title was collapsed in Phase 5 dedup. Final 107 "
        "records include the original Whiska Creek vanguard footprint, the "
        "Sec 6-12-12-W3 quarters (originally under vanguard, briefly "
        "reassigned to __neville__, folded back), 10 Plan N3619 town-lot "
        "placeholders rendered around Neville centroid (49.79°N -107.55°W), "
        "and 1 planned-parcel skip (BLK-B-PLAN-101658124) pending cadastral "
        "data."
    ),
}
