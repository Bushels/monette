  ...
  properties: [
    ...
    { id:"calderbank", name:"Calderbank", internalName:"Enfield", province:"SK", region:"Central SK", lat:50.28, lng:-106.78,
      ...
      mflTitleSnapshot:{
        ...
        significance:"Largest title-row collapse in the dataset: 138 CSV title rows for RM Enfield 194 + RM Morse 165 collapse to 110 unique map features (28 duplicate-titled with extension variants). RM Morse 165's 64 parcels fold into calderbank per Codex round-1 endorsement (the townships are contiguous with RM Enfield 194 — same operating block). Plus 3 net-new ADDs awaiting Phase 4 polygon computation.",
        methodologyLog:"docs/logs/sk-titles-2026-01-18.md",
      },
    ...
    { id:"vanguard", name:"Vanguard", province:"SK", region:"Southwest SK", lat:49.92, lng:-107.24,
      ...
      parcels:108, titled:14358, cultivated:13851, waste:506, assessment:32448000, owned:9900, rented:4458,
      mflTitleSnapshot:{
        source:"ISC title export — MONETTE FARMS LTD.",
        snapshotDate:"2026-01-18",
        totalRecords:108,
        mflTitledRecords:80,
        flaggedRecords:28,
        buckets:{keep:65,flag:28,add:15,reassignIn:0,reassignOut:0},
        flagSubtypes:{"glen_bain_not_in_mfl_csv":6,"whiska_creek_not_in_mfl_csv":22},
        significance:"Folded the 16 Village of Neville town-lot records into vanguard as the closest property anchor (~17km NE of Neville village). Includes 14 net-new town-lot ADDs in Plan N3619 (Lot/Block format, geometry pending Phase 4 town-lot math) plus 2 quarter-section records (SE/SW-6-12-12-W3) that were originally under vanguard, moved to __neville__ via Wave C reassign-out, then folded back here.",
        methodologyLog:"docs/logs/sk-titles-2026-01-18.md",
      },
    ...
    { id:"swift-current", name:"Swift Current", province:"SK", region:"Southwest SK", lat:50.2851, lng:-107.7972,
      ...
      parcels:30, titled:49775, cultivated:0, waste:0, assessment:0, owned:49775, rented:0,
      mflTitleSnapshot:{
        source:"ISC title export — MONETTE FARMS LTD.",
        snapshotDate:"2026-01-18",
        totalRecords:30,
        mflTitledRecords:30,
        flaggedRecords:0,
        buckets:{keep:0,flag:0,add:14,reassignIn:16,reassignOut:0},
        significance:"First geometry landing for the court-file Swift Current property. Was point-only with a 49,775-acre headline claim and no parcel rows. The 2026-01-18 ISC snapshot adds 30 records: 16 reassigned in from wymark (Stewart Valley townships T13/R13-R14/W3 — clean quarters and LSDs that the older Wymark sale-package XLSX had absorbed) plus 14 net-new LSD ADDs. Geometry pending DLS LSD computation in Phase 4. The 49,775-acre court-file claim is NOT reconciled by this 31-CSV-row subset — the bulk likely sits under non-MFL Monette entities or leased land outside the ISC title-export scope.",
        methodologyLog:"docs/logs/sk-titles-2026-01-18.md",
      },
      soils:[], crops2025:[], crops2024:[],
    ...
    { id:"regina-south", name:"Regina South", province:"SK", region:"Regina, SK", lat:50.215, lng:-104.618,
      ...
      parcels:126, titled:32056, cultivated:0, waste:0, assessment:0, owned:32056, rented:0,
      mflTitleSnapshot:{
        source:"ISC title export — MONETTE FARMS LTD.",
        snapshotDate:"2026-01-18",
        totalRecords:126,
        mflTitledRecords:126,
        flaggedRecords:0,
        buckets:{keep:1,flag:0,add:125,reassignIn:0,reassignOut:0},
        significance:"First geometry landing for the court-file Regina South property. Was point-only with a 32,056-acre headline claim and no parcel rows. The 2026-01-18 ISC snapshot adds 126 records covering RM Lajord 128 (Riceton/Drinkwater area, 65 parcels in T15-R18-W2M), RM Bratt's Lake 129 (Wilcox area, 46 parcels), RM Edenwold 158 (White City area, 14 parcels in T16-R18-W2M directly N of Lajord), and RM Longlaketon 219 (Lumsden area, 1 parcel reassigned from raymore). Lajord + Edenwold form a contiguous 79-parcel block south-then-north of Regina city. 125 records have geometry: null pending DLS quarter polygon computation in Phase 4.",
        methodologyLog:"docs/logs/sk-titles-2026-01-18.md",
      },
      soils:[], crops2025:[], crops2024:[],
