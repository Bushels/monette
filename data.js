...
window.MONETTE_DATA = {
  ...
  properties: [
    ...
    { id:"regina-south", name:"Regina South", province:"SK", region:"Regina, SK", lat:50.215, lng:-104.618,
      ...
      geometryStatus:"point-only", locationPrecision:"regional", tags:["court-file","regina-i","needs-geometry","wolfe-yard","kambietz-yard","binyard","arizona-link","multi-yard"],
      yards:[
        {
          id:"wolfe",
