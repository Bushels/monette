  ...
  properties: [
    ...
    { id:"vanguard", name:"Vanguard", province:"SK", region:"Southwest SK", lat:49.92, lng:-107.24,
      ...
      mflTitleSnapshot:{
        ...
        mflTitledRecords:77,
        flaggedRecords:28,
        buckets:{keep:65,flag:28,add:12,reassignIn:0,reassignOut:0},
    ...
    { id:"mt-fly-creek", name:"Fly Creek Farm", province:"MT", region:"Big Horn County, MT", lat:45.6925, lng:-107.6233,
      ...
      soils:[], crops2025:[["Grain",32756]], crops2024:[],
      segment:"Grain", legalOwner:"Monette Farms USA, Inc.", beneficialOwner:"Direct",
      geometryStatus:"public-cadastral-package-crosswalk", locationPrecision:"state-cadastral-boundary", tags:["court-file","montana","big-horn-county","helkaa-exhibit-d","fly-creek","premier-listing","parcel-mapped"],
      ...
      mappedDeededAc:32557.384,
      notes:"Premier's live 2026-07-15 listing reports 32,756 deeded + 6,454 leased = 39,210 total acres. The mapped DNRC owner-query cluster contains 95 parcels / 32,557.384 assessed acres; the 198.616-acre difference remains an explicit title-geometry gap. The March 2026 tender reported 6,489.30 leased acres and is retained as historical operating evidence, not the current broker total." },
    { id:"mt-st-xavier-camp4", name:"St. Xavier Camp 4", province:"MT", region:"Big Horn County, MT", lat:45.4225, lng:-107.8839,
      ...
      parcels:66, titled:11455, cultivated:11455, waste:0, assessment:0, owned:11455, rented:22828,
      soils:[], crops2025:[["Grain",11455]], crops2024:[],
      segment:"Grain", legalOwner:"Monette Farms USA, Inc.", beneficialOwner:"Direct",
      geometryStatus:"public-cadastral-package-crosswalk", locationPrecision:"state-cadastral-boundary", tags:["court-file","montana","big-horn-county","helkaa-exhibit-d","crow-reservation","camp-4","premier-listing","parcel-mapped"],
      ...
      mappedDeededAc:10201.820,
      notes:"Premier's live 2026-07-15 listing reports 11,455 deeded + 22,828 leased = 34,282 total acres. The mapped DNRC owner-query cluster contains 66 parcels / 10,201.820 assessed acres; the 1,253.180-acre difference remains an explicit title-geometry gap. The March 2026 tender's 26,746.86 leased acres are retained as historical operating evidence." },
    { id:"mt-nieden-camp1", name:"Nieden/Niessen Camp 1", province:"MT", region:"Big Horn County, MT", lat:45.7333, lng:-107.6111,
      ...
      parcels:56, titled:8060, cultivated:8060, waste:0, assessment:0, owned:8060, rented:9159,
      soils:[], crops2025:[["Grain",8060]], crops2024:[],
      segment:"Grain", legalOwner:"Monette Farms USA, Inc.", beneficialOwner:"Direct",
      geometryStatus:"public-cadastral-package-crosswalk", locationPrecision:"state-cadastral-boundary", tags:["court-file","montana","big-horn-county","helkaa-exhibit-d","camp-1","premier-listing","parcel-mapped"],
      ...
      mappedDeededAc:7982.248,
      notes:"Premier's live 2026-07-15 listing reports 8,060 deeded + 9,159 leased = 17,219 total acres. The mapped DNRC owner-query cluster contains 56 parcels / 7,982.248 assessed acres; the 77.752-acre difference remains an explicit title-geometry gap. Premier labels this public package Camp 1 Farm; Nieden/Niessen remains the court-file alias." },
    { id:"mt-pivot", name:"The Pivot Farm", province:"MT", region:"Big Horn County, MT", lat:45.8157, lng:-107.5587,
      rms:["Big Horn County","Hardin"],
      parcels:3, titled:1473, cultivated:1473, waste:0, assessment:0, owned:1473, rented:0,
      soils:[], crops2025:[["Grain",1473]], crops2024:[],
      segment:"Grain", legalOwner:"Monette Farms USA, Inc.", beneficialOwner:"Direct",
      geometryStatus:"public-cadastral-package-crosswalk", locationPrecision:"state-cadastral-boundary", tags:["court-file","montana","big-horn-county","helkaa-exhibit-d","ragland","pivot","premier-listing","parcel-mapped"],
      parentPropertyId:"montana",
      affidavitOwnedAcres:1473,
      affidavitOwnedAcresSource:"Darrel Monette Affidavit Exhibit D ¶89",
      mappedDeededAc:787.441,
      notes:"Crosswalked from the 1,473-acre court-file Ragland row to Premier's 1,473-acre Pivot package using the exact acreage match plus the distinct T01N-R33E cadastral cluster shown in the Camp 1 tender map. The mapped DNRC owner-query cluster contains 3 parcels / 787.441 assessed acres; the 685.559-acre difference remains an explicit title-geometry gap." },
    { id:"mt-hardin-rail", name:"Hardin Infrastructure & Rail Site", province:"MT", region:"Hardin, Big Horn County, MT", lat:45.7325, lng:-107.6120,
      showMapMarker:true,
      rms:["Big Horn County","Hardin"],
      parcels:0, titled:7, cultivated:0, waste:0, assessment:0, owned:7, rented:0,
      soils:[], crops2025:[], crops2024:[],
      segment:"Infrastructure", legalOwner:"Monette Farms USA, Inc.", beneficialOwner:"Direct",
      geometryStatus:"point-only", locationPrecision:"city-approximate", tags:["montana","big-horn-county","hardin","rail-site","premier-listing","needs-geometry"],
      parentPropertyId:"montana",
      notes:"Premier's live 2026-07-15 portfolio table reports a 7-acre deeded infrastructure and rail site. No parcel, address, legal description, or broker map was published for a defensible boundary, so this is an explicitly approximate Hardin point and no leased or deeded polygon is fabricated." },
    { id:"mt-ragland-camp1", name:"Ragland Camp 1", province:"MT", region:"Big Horn County, MT", lat:45.7150, lng:-107.5680,
      ...
      affidavitOwnedAcresSource:"Darrel Monette Affidavit Exhibit D ¶89",
      offeringStatus:"not-crosswalked",
      notes:"737 ac per Affidavit Exhibit D. This court-file row cannot be the live Premier Hardin rail site, which is 7 deeded acres. It is retained as an unreconciled historical child, excluded from the current five-asset public offering, and still needs precise title/parcel evidence." },
    { id:"montana", name:"Montana (parent rollup)", province:"MT", region:"Big Horn County, SE Montana", lat:45.62, lng:-107.81,
      aggregator:true,
      childPropertyIds:["mt-fly-creek","mt-st-xavier-camp4","mt-nieden-camp1","mt-pivot","mt-hardin-rail"],
      nonOfferingRelatedPropertyIds:["mt-ragland-camp1"],
      rms:["Big Horn County"],
      ...
      currentOffering:{
        source:"Premier Land Company live Monette Portfolio page",
        ...
        totalAc:92193,
        seededAc:63049,
        computedDeededPlusLeasedAc:92192,
        sumPublishedChildTotalsAc:92191,
        publishedTotalReconciliationDeltaAc:1,
        publishedChildTotalReconciliationDeltaAc:2,
        childPropertyIds:["mt-fly-creek","mt-st-xavier-camp4","mt-nieden-camp1","mt-pivot","mt-hardin-rail"],
        rule:"Marketing totals describe the current offering. Premier's visible rows contain a 1–2 acre arithmetic discrepancy, so preserve the published figures and show the delta rather than forcing a false reconciliation. They do not replace DNRC/DOR title geometry or March 2026 operating-acre evidence. Never add this umbrella acreage to its children."
      },
      ...
      changeLog:[
        {at:"2026-07-15T00:00:00-06:00", type:"public-offering", title:"Premier acreage refresh and five-package cadastral crosswalk", detail:"Premier's live page now reports 53,751 deeded + 38,441 leased = 92,193 total acres, with 63,049 seeded. DNRC owner-query polygons are assigned to Fly Creek, Camp 4, Camp 1, and Pivot by their distinct PLSS clusters. Hardin Infrastructure & Rail remains a 7-acre approximate point because no defensible parcel boundary is published; the 737-acre Ragland Camp 1 court row is excluded from the offering."},
...
window.MONETTE_DATA.sispByProperty = {
  ...
  "montana":            { status:"listed", tier:"confirmed", broker:"Premier Land Company", contact:"Bryan Anderson · 406-259-2544", package:"Monette Portfolio — 5 integrated Montana assets", price:"$96,000,000 USD", deededAc:53751, leasedAc:38441, totalAc:92193, seededAc:63049, listingUrl:"https://www.premierlandcompany.com/ranch/monette-portfolio/", confidence:"high", sourceCheckedAt:"2026-07-15", note:"Current umbrella listing. Premier's displayed deeded + leased figures equal 92,192 acres and its five displayed child totals equal 92,191, versus the published 92,193 portfolio total; the 1–2 acre source discrepancy is preserved. Do not add this parent acreage or price to its children.", source:"Premier Land Company live listing", listings:[
    {name:"Fly Creek Farm", price:"$38,000,000 USD", listingAc:39210, listingUrl:"https://www.premierlandcompany.com/ranch/fly-creek-farm/"},
    {name:"Camp 4 Farm", price:"$27,500,000 USD", listingAc:34282, listingUrl:"https://www.premierlandcompany.com/ranch/camp-4-farm/"},
    {name:"Camp 1 Farm", price:"$17,000,000 USD", listingAc:17219, listingUrl:"https://www.premierlandcompany.com/ranch/camp-1-farm-2/"},
    {name:"The Pivot Farm", price:"$11,500,000 USD", listingAc:1473, listingUrl:"https://www.premierlandcompany.com/ranch/monette-portfolio/"}
  ] },
  "mt-fly-creek":       { status:"listed", tier:"confirmed", broker:"Premier Land Company", contact:"Bryan Anderson · 406-259-2544", package:"Fly Creek Farm", price:"$38,000,000 USD", deededAc:32756, leasedAc:6454, totalAc:39210, listingUrl:"https://www.premierlandcompany.com/ranch/fly-creek-farm/", confidence:"high", sourceCheckedAt:"2026-07-15", source:"Premier Land Company live listing" },
  "mt-st-xavier-camp4": { status:"listed", tier:"confirmed", broker:"Premier Land Company", contact:"Bryan Anderson · 406-259-2544", package:"Camp 4 Farm (St. Xavier)", price:"$27,500,000 USD", deededAc:11455, leasedAc:22828, totalAc:34282, listingUrl:"https://www.premierlandcompany.com/ranch/camp-4-farm/", confidence:"high", sourceCheckedAt:"2026-07-15", note:"Large leased share; leased acreage is broker-reported and is not drawn as parcel geometry.", source:"Premier Land Company live listing" },
  "mt-nieden-camp1":    { status:"listed", tier:"confirmed", broker:"Premier Land Company", contact:"Bryan Anderson · 406-259-2544", package:"Camp 1 Farm", price:"$17,000,000 USD", deededAc:8060, leasedAc:9159, totalAc:17219, listingUrl:"https://www.premierlandcompany.com/ranch/camp-1-farm-2/", confidence:"high", sourceCheckedAt:"2026-07-15", note:"Premier labels the public package Camp 1 Farm; Nieden/Niessen remains the court-file alias.", source:"Premier Land Company live listing" },
  "mt-pivot":           { status:"listed", tier:"confirmed", broker:"Premier Land Company", package:"The Pivot Farm", price:"$11,500,000 USD", deededAc:1473, leasedAc:0, totalAc:1473, listingUrl:"https://www.premierlandcompany.com/ranch/monette-portfolio/", confidence:"high", sourceCheckedAt:"2026-07-15", note:"Package acreage and inclusion come from Premier; the standalone price is reported by Grainews.", source:"Premier Land Company live listing + Grainews" },
  "mt-hardin-rail":     { status:"listed", tier:"confirmed", broker:"Premier Land Company", package:"Hardin Infrastructure & Rail Site", deededAc:7, leasedAc:0, totalAc:7, listingUrl:"https://www.premierlandcompany.com/ranch/monette-portfolio/", confidence:"high", sourceCheckedAt:"2026-07-15", note:"Included in the $96M umbrella offering; no standalone price or defensible parcel boundary is published.", source:"Premier Land Company live listing" },
